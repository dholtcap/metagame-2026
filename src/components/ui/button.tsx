  ...
  "inline-flex shrink-0 items-center justify-center gap-2 font-roboto font-semibold whitespace-nowrap transition-[transform,background,border-color,box-shadow] duration-150 outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/60 disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        default:
          "rounded-lg border-[1.5px] border-transparent bg-meeple text-white hover:-translate-y-px hover:bg-meeple-dark",
        // Navy solid — secondary actions / archive links ("See last year's").
        navy: "rounded-lg border-[1.5px] border-transparent bg-navy text-white hover:-translate-y-px hover:bg-navy2",
        // Outlined-on-navy.
        ghost:
          "rounded-lg border-[1.5px] border-cream/55 text-cream hover:-translate-y-px hover:border-cream hover:bg-cream/10",
        // Ticket-tile preset: bordered navy face where a salmon hard offset
        // shadow grows and the face slides up-left on hover.
        raised:
          "border-2 border-cream/30 bg-navy text-cream shadow-[0_0_0_0_#fa8072] hover:-translate-x-[5px] hover:-translate-y-[5px] hover:border-cream/60 hover:shadow-[8px_8px_0_0_#fa8072]",
      },
      size: {
